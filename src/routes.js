...
// const osList = React.lazy(() => import('./views/serviceOrders/UsersList'))
...
const routes = [
  ...
  // { path:'/os/oslist', name: 'Lista de Produtos', element: TypeServiceList },
  // { path:'/add/productAdd', name: '', element: },
  // { path:'/add/serviceAdd', name: '', element: },
  // { path:'/add/typeEquipamentAdd', name: '', element: },
  // { path:'/add/equipamentAdd', name: '', element: },
]
